import { fromArray2Object } from "../utils";

export const vueTmp:any = [
  {
    filename: 'vue',
    kind: 'directory',
    path: '/vue',
...
export const webcontainerFmtReact = fromArray2Object(reactTmp) || {};
export const webcontainerFmtVue = fromArray2Object(vueTmp) || {};
